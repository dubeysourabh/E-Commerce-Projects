<%@ Page Language="C#" MasterPageFile="~/Agent/AgentMasterPage.master" AutoEventWireup="true" CodeFile="RepTrackOrder.aspx.cs" Inherits="Agent_RepTrackOrder" %>
                        ...
                        <tr>
                            <td colspan="3" align="center" style="color: Black;">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Grid"
                                    ...
                                    ShowFooter="false" OnSelectedIndexChanged="OnSelectedIndexChanged" OnRowDeleting="GridView1_RowDeleting" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Total<br/> PV">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Shipping <br/>Price">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Invoice">
                                             <ItemTemplate>
                                               <asp:LinkButton ID="lnkInvoice" runat="server" Text="Invoice" CommandName="Update"></asp:LinkButton>
                                             </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Cancel Order" Visible="false">
                                            <ItemTemplate>
                                ...
                                <asp:Panel ID="pnlPopup" runat="server" CssClass="modalPopup" Style="display: none;
                                    ...
                                    <div>
                                        <table border="0" cellpadding="0" cellspacing="0" style="font-weight: bold; width:90%">
                                            <tr>
                                                <td colspan="3">
                                                    &nbsp;
                                                </td>
                                ...
                                <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" Style="display: none;
                                    ...
                                    <div>
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                              ...
                                              <tr>
                                                <td colspan="3" align="center">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" Display="Dynamic" ControlToValidate="txtReason" ValidationGroup="r"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" align="center">
                                            ...
                                            <tr>
                                                <td colspan="3" align="center">
                                                   <asp:Button ID="btnCancel" runat="server" Text="Submit" CssClass="btn blue" OnClick="btnCancel_Click" ValidationGroup="r"/>
                                                    <asp:Button ID="Button1" runat="server" Text="Cancel" CssClass="btn blue" />
                                                </td>
                                            </tr>
